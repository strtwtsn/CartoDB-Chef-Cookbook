...
This cookbook assumes that you are running Ubuntu on a clean new EC2 instance.  It should not be used on any server which has postgresql already installed.
